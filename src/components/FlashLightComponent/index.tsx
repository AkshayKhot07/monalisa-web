...
const FlashlightEffect = () => {
  ...
  const seekRef = useRef<HTMLParagraphElement>(null);
      ...
      <div className="container">
        ...
        <div className="relative z-10 p-4 min-h-screen flex flex-col items-center justify-center">
          <p className="text-base text-justify leading-7 mb-4">
            ...
            Sapiente corporis a illo labore assumenda est nam quisquam veniam
            rem voluptatum quis pariatur quae asperiores repellendus in
            similique, quibusdam dolorum optio incidunt laudantium! Iusto
            commodi odit ea sequi cupiditate alias obcaecati in qui, vero sunt
            sint maxime voluptatibus?
          </p>
          <p
            ref={seekRef}
            className={classNames(
              ...
              seekHover
                ? "font-bold bg-gradient-to-r from-orange-700 via-blue-500 to-green-400 text-transparent bg-clip-text bg-300% animate-gradient"
                : "text-[#171717]"
            )}
          >
          ...
          <p className="text-base text-justify leading-7 mb-4">
            ...
            pariatur maiores eum deserunt, similique amet! Dignissimos culpa
            fuga mollitia, maxime laborum cupiditate, nobis minus quisquam
            libero recusandae cum cumque consequatur vero esse quaerat odio quia
            eligendi porro unde! Sed veniam id odit?{" "}
            <span
              ref={buttonRef}
